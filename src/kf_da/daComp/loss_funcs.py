...
def create_loss_fn(
    ...
    def loss_fn(Z0, PP_opt):
        ...
        # Necessary for long trajectories where activation memory would be prohibitive.
...
class MSE_Vel(Loss_fn):
    ...
    def g(self, xp_DA, yp_DA, xp_trg, yp_trg,
        ...
        # Compare velocity at particle locations rather than on the full grid,
        # so the loss is sensitive only to the flow seen by the particles.
